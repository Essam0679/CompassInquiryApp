...
import { useRouter } from 'expo-router';
import Header from '@/components/common/Header';
import { User, Settings, LogOut, Moon, Bell, Globe, Shield, ChevronRight } from 'lucide-react-native';
    ...
    return (
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.centerContent}>
          <Text style={[styles.signInText, { color: colors.text }]}>{t('signInRequired')}</Text>
          <TouchableOpacity 
            style={[styles.signInButton, { backgroundColor: colors.primary }]} 
            onPress={() => router.push('/(auth)/login')}
          >
            <Text style={[styles.signInButtonText, { color: colors.white }]}>{t('signIn')}</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
      ...
      <ScrollView style={styles.scrollView}>
        <View style={[styles.profileCard, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.profileInfo}>
            ...
            {user.company && (
              <Text style={[styles.profileCompany, { color: colors.textSecondary }]}>{user.company}</Text>
            )}
          </View>
          <TouchableOpacity 
        ...
        <View style={styles.section}>
          ...
          <View style={[styles.menuCard, { backgroundColor: colors.card }]}>
            ...
            >
              ...
              <Text style={[styles.menuItemText, { color: colors.text }]}>{t('privacyPolicy')}</Text>
              <ChevronRight size={18} color={colors.textSecondary} />
            </TouchableOpacity>
