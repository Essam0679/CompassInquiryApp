...
=======
  ...
  const sendEmail = (quote) => {
    const subject = encodeURIComponent('Quote Request Details');
...
${JSON.stringify(quote.details, null, 2)}
    ...
    Linking.openURL(`mailto:essam.alkhayyat@compasslog.com?subject=${subject}&body=${body}`);
  };
        ...
        <ScrollView style={styles.scrollView} contentContainerStyle={styles.content}>
          {quotes.length === 0 ? (
            <View style={styles.emptyState}>
              ...
              >
                <Text style={[styles.newQuoteButtonText, { color: colors.white }]}>
                  {t('requestQuote')}
                </Text>
              </TouchableOpacity>
            </View>
            ...
            quotes.map((quote) => (
              ...
              >
                <View style={styles.quoteHeader}>
                  <View>
                    <Text style={[styles.quoteType, { color: colors.text }]}>
                      {quote.quoteType}
                    </Text>
                  ...
                  <View style={[
                    styles.statusBadge, 
                    { backgroundColor: quote.status === 'pending' ? colors.warning + '20' : colors.success + '20' }
                  ]}>
                    <Text style={[
                      styles.statusText, 
                      { color: quote.status === 'pending' ? colors.warning : colors.success }
                    ]}>
                      {t(quote.status)}
                    </Text>
                  </View>
